...
<div class="card">
    <img src="{{ asset('storage/images/main_miska.png') }}" class="card-img-top" alt="...">
</div>
                ...
                @foreach($groupChunk as $group)
                    <div class="col-sm-4">
                        <div class="card" style="width: 18rem;">
                            <img src="{{ $group->img_path ? asset('storage/'.$group->img_path) : asset('storage/images/default_category.jpg') }}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <a href="{{ route('goods.category', ['category' => $group->category_id]) }}" class="card-text">{{ $group->name }} ({{ $group->count }})</a>
                            </div>
                        </div>
                    </div>
                @endforeach
